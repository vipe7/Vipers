...
curl -o C:\Install.zip https://github.com/vipe7/Vipers/raw/master/Update.zip
Remove-Item C:\Rainmeter -Force -Recurse
Expand-Archive -Force C:\Install.zip C:\Rainmeter
...
Remove-Item C:\Install.zip -Force -Recurse
